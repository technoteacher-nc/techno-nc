  ...
  },
  {
    ...
    notions: [
      ...
      },
      {
        ...
        activites: ['s2-a04-4eme', 's5-a01-4eme', 's5-a05-4eme'],
      },
      {
    ...
    notions: [
      {
        ...
        activites: ['s2-a04-5eme', 's2-a04-4eme', 's5-a01-5eme', 's6-a02-4eme'],
      },
      {
  ...
  },
  {
    ...
    notions: [
      ...
      },
      {
        ...
        piege: "Comparer deux ampoules n'a de sens qu'à lumière égale : la LED de 8 W éclaire autant qu'un filament de 60 W, elle n'éclaire pas moins.",
        activites: ['s1-a03-5eme', 's1-a03-4eme', 's2-a05-4eme'],
      },
      {
        nom: 'Fréquence', symbole: 'Hz, MHz, GHz',
        def: "Le nombre de fois qu'une chose se répète en une seconde. Pour un processeur : le nombre d'opérations par seconde.",
        repere: '3 GHz, c\'est trois milliards d\'opérations par seconde.',
        piege: "Confondre GHz et Go. Le GHz est une VITESSE, le Go une QUANTITÉ de place : 8 Go de mémoire ne rendent pas la machine plus rapide, ils lui donnent plus de place pour travailler à la fois.",
        activites: ['s1-a03-5eme', 's1-a03-4eme'],
      },
      {
        ...
        activites: ['s1-a03-5eme', 's1-a03-4eme', 's2-a07-4eme', 's3-a01-5eme'],
      },
      {
        ...
        activites: ['s1-a06-4eme', 's3-a02-5eme'],
      },
    ],
  },
];
